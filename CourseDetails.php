    ...
    <img style="" src="" alt="">
      <div class="container">
          ...
          <?php
                ...
                $mysql = "select c.course_id,c.course_name,c.Start_date,c.teaching_hrs,c.credits from course as c,faculty as f
                where c.course_id = f.course_id and
                f.f_id = '$id'";
                ...
                if ($result->num_rows > 0) {
                    ...
                    while($row = $result->fetch_assoc()) {
                      ...
                      <table>
                            ...
                            <tr id=\"tdata\">
                                <td><b>Start Date: </b>". $row["Start_date"] ."</td>
                            </tr>
                            <tr id=\"tdata\">
                                <td><b>Teaching Hours: </b>". $row["teaching_hrs"] ."</td>
                            </tr>
                            <tr id=\"tdata\">
                                <td><b>Credits: </b>". $row["credits"] ."</td>
                            </tr>
                            <hr>
                      </table>
                      ";
