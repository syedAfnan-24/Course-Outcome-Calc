...
<head>
  ...
  <title>Course Outcome MSE2</title>
    ...
    <img style="" src="" alt="">
      <div class="container">
          ...
          <?php
                ...
                $mysql = "select mse2.USN,mse2.course_id,s.Student_name,mse2.1a,mse2.1b,mse2.1c,mse2.2a,mse2.2b,mse2.2c,mse2.3a,mse2.3b,mse2.3c,
                case
                when mse2.1a >= 2.4 then '1'
                else '0'
                end as CO_1a,
                case
                when mse2.1b >= 1.8 then '1'
                else '0'
                end as CO_1b,
                case
                when mse2.1c >= 1.8 then '1'
                else '0'
                end as CO_1c,
                case
                when mse2.2a >= 2.4 then '1'
                else '0'
                end as CO_2a,
                case
                when mse2.2b >= 1.8 then '1'
                else '0'
                end as CO_2b,
                case
                when mse2.2c >= 1.8 then '1'
                else '0'
                end as CO_2c,
                case
                when mse2.3a >= 2.4 then '1'
                else '0'
                end as CO_3a,
                case
                when mse2.3b >= 1.8 then '1'
                else '0'
                end as CO_3b,
                case
                when mse2.3c >= 1.8 then '1'
                else '0'
                end as CO_3c from mse2,faculty as f,students as s
                where mse2.USN = s.USN and
                mse2.course_id = f.course_id and
                f.f_id = '$id'";
