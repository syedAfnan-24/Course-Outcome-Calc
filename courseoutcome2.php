...
<head>
  ...
  <title>Course Out Come MSE3</title>
    ...
    <img style="" src="" alt="">
      <div class="container">
          ...
          <?php
                ...
                $mysql = "select mse3.USN,mse3.course_id,s.Student_name,mse3.1a,mse3.1b,mse3.1c,mse3.2a,mse3.2b,mse3.2c,mse3.3a,mse3.3b,mse3.3c,
                case
                when mse3.1a >= 2.4 then '1'
                else '0'
                end as CO_1a,
                case
                when mse3.1b >= 1.8 then '1'
                else '0'
                end as CO_1b,
                case
                when mse3.1c >= 1.8 then '1'
                else '0'
                end as CO_1c,
                case
                when mse3.2a >= 2.4 then '1'
                else '0'
                end as CO_2a,
                case
                when mse3.2b >= 1.8 then '1'
                else '0'
                end as CO_2b,
                case
                when mse3.2c >= 1.8 then '1'
                else '0'
                end as CO_2c,
                case
                when mse3.3a >= 2.4 then '1'
                else '0'
                end as CO_3a,
                case
                when mse3.3b >= 1.8 then '1'
                else '0'
                end as CO_3b,
                case
                when mse3.3c >= 1.8 then '1'
                else '0'
                end as CO_3c from mse3,faculty as f,students as s
                where mse3.USN = s.USN and
                mse3.course_id = f.course_id and
                f.f_id = '$id'";
