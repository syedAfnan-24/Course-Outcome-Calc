          ...
          <div class="col-lg-8">
            <div class="portfolio-details-slider swiper">
                <div class="signup-form">
                  <form action="mse1delete.php" method="post" enctype="multipart/form-data">
                    <h2>Marks Deletion</h2>
                    <p class="hint-text">Delete MSE 1 marks of your students:</p>
                    <?php
