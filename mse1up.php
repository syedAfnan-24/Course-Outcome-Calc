          ...
          <div class="col-lg-8">
            <div class="portfolio-details-slider swiper">
                <div class="signup-form">
                  <form action="mse1update.php" method="post" enctype="multipart/form-data">
                    <h2>Update Marks</h2>
                    <p class="hint-text">Enter MSE 1 marks of your students:</p>
                    <?php
                      ...
                      $conn->close();
                    ?>
                    <h6>Enter zero if not attempted</h6>
                    <br>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <h6>Question 1</h6>
                            <div class="col"><input type="text" class="form-control" name="1a" pattern="[0-4]" placeholder="1a - maximum marks 4" required="required"></div> 
                            <div class="col"><input type="text" class="form-control" name="1b" pattern="[0-3]" placeholder="1b - maximum marks 3" required="required"></div>
                            <div class="col"><input type="text" class="form-control" name="1c" pattern="[0-3]" placeholder="1c - maximum marks 3" required="required"></div>
                        </div> <br>
                        <div class="row">
                            <h6>Question 2</h6>
                            <div class="col"><input type="text" class="form-control" name="2a" pattern="[0-4]" placeholder="2a - maximum marks 4" required="required"></div> 
                            <div class="col"><input type="text" class="form-control" name="2b" pattern="[0-3]" placeholder="2b - maximum marks 3" required="required"></div>
                            <div class="col"><input type="text" class="form-control" name="2c" pattern="[0-3]" placeholder="2c - maximum marks 3" required="required"></div>
                        </div> <br>
                        <div class="row">
                            <h6>Question 1</h6>
                            <div class="col"><input type="text" class="form-control" name="3a" pattern="[0-4]" placeholder="3a - maximum marks 4" required="required"></div> 
                            <div class="col"><input type="text" class="form-control" name="3b" pattern="[0-3]" placeholder="3b - maximum marks 3" required="required"></div>
                            <div class="col"><input type="text" class="form-control" name="3c" pattern="[0-3]" placeholder="3c - maximum marks 3" required="required"></div>
                        </div> <br>
                        <div class="form-group">
