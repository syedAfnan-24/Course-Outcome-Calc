        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-8">
            <div class="portfolio-details-slider swiper">
                        ...
                        <div class="signup-form">
                <form action="reset1.php" method="post" enctype="multipart/form-data">
                    <h2>Reset Password</h2>
                    <p class="hint-text">Reset Password:</p>
                    <div class="form-group">
                        <div class="row">
                            <div class="col"><input type="text" class="form-control" name="first_name" placeholder="User id/Faculty id" required="required"></div>
                        </div>        	
                    </div> <br>
                    <div class="form-group">
