        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-8">
            <div class="portfolio-details-slider swiper">
                    ...
                    $sql = "INSERT INTO login (login_id,password,name)
                    VALUES ('$uname', '$pass', '$nam')";
                    ...
                    $mysql = "INSERT INTO faculty (f_id,f_name,position,dep_id,course_id,Date_of_join)
                    VALUES ('$uname', '$nam', '$desig', '$did', '$cid', '$doj')";
                    ...
                    $msql = "INSERT INTO faculty_qualification (f_id,Qualification)
                    VALUES ('$uname', '$qual')";
